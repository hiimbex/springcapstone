...
if __name__ == "__main__":
    ...
    verifyTrueSample = verify_sig(
        mt, sample_index, sample_employee, sample_transaction)
    print('Verify True Sample: ', verifyTrueSample, '\n')

    # use the same data to verify a different index to demonstrate failure
    verifyFalseSample = verify_sig(
        mt, sample_index + 1, sample_employee, sample_transaction)
